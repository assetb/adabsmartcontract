...
contract BurnableToken is BasicToken {
    ...
    */
    ...
    function _burn(address _who, uint256 _value) internal {
        require(_value <= balances[_who],"Value over than balance");
...
contract FreezableToken is StandardToken {
    ...
    */
    ...
    /**
     * @dev date release frozen token is 27.01.2019 - UnixTimeStamp 1559260800
    */
    uint256 public dateRelease = 1548547200;
    ...
    function freezeTo(address _to, uint _amount) public {
        require(_to != address(0),"Address should be");
        require(_amount <= balances[msg.sender],"Value over than balance");
...
contract ADABToken is FreezableToken, BurnableToken {
    ...
    constructor(address _CrowdsaleAddress) public {
        ...
        dateStartTransfer = 1548547200; // 27.01.2019
    }
    
    modifier onlyOwner() {
        // only Crowdsale contract
        require(msg.sender == CrowdsaleAddress,"CrowdsaleAddress");
        _;
    }
...
contract AdabCrowdsale is Ownable {
    ...
    */
    ...
    constructor() public {
		...
		//ADABToken vs ether rate. ADABToken = 0.1$
        rate = 50 ether;
    }
    ...
    /**
     * @dev the function to set rate between ADABToken and ether
	 * 1 ADABToken equals to 0.1 USD. 
	 * function will be invoked each 15 minutes from backend to set rate 
     */ 
    function setRate (uint256 _newRate) public restricted {
        rate = _newRate;
    }
    
    /**
     * @dev the function to get rate between ADABToken and ether
    ...
    function createTokens() internal {
        ...
        } else if(tokens >= 250000) {
            bonusTokens = tokens.div(20).mul(3);
        ...
        tokens += bonusTokens;
        transferComplex(msg.sender,tokens,tokens);
    }
